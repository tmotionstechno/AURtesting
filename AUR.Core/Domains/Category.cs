...
namespace AURScheduler.Core.Domains
{
    ...
    public partial class Category : BaseEntity
    {
        ...
        /// <summary>
        /// Gets or sets the CategoryNumber
        /// </summary>
        public string CategoryNumber { get; set; }

        /// <summary>
        /// Gets or sets the HeirarchyNumber
        /// </summary>
        public string HeirarchyNumber { get; set; }

        /// <summary>
        /// Gets or sets the DepartmentNumber
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the CommodityNumber
        /// </summary>
        public string CommodityNumber { get; set; }

        /// <summary>
        /// Gets or sets the CommodityName
        /// </summary>
        public string CommodityName { get; set; }

        /// <summary>
        /// Gets or sets the SubCommodityNumber
        /// </summary>
        public string SubCommodityNumber { get; set; }

        /// <summary>
        /// Gets or sets the SubCommodityName
        /// </summary>
