...
namespace AURScheduler.DBContext
{
    ...
    public static partial class SqlParameterHelper
    {
        ...
        /// <summary>
        /// Get Datatable type parameter
        /// </summary>
        /// <param name="parameterName">Parameter name</param>
        /// <param name="parameterValue">Parameter value</param>
        /// <returns>Parameter</returns>
        public static DataParameter GetStructuredParameter(string parameterName, DataTable dataTable)
        {
            return GetParameter(DataType.Structured, parameterName, dataTable);
        }

        /// <summary>
        /// Get Table Type Structured Parameter
        /// </summary>
        /// <param name="parameterName">Parameter name</param>
        /// <param name="parameterValue">Parameter value</param>
        /// <returns>Parameter</returns>
        public static DataParameter GetTableTypeStructuredParameter(string parameterName, DataTable parameterValue)
        {
            return GetParameter(DataType.Structured, parameterName, parameterValue);
        }
        #endregion
    }
}
